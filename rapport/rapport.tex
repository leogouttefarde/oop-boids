...
Afin de faciliter la navigation à travers les différentes classes du projet et de regrouper les classes similaire, nous avons crée différents paquetage :
\begin{itemize}
...
\item \texttt{event} : contient l'\texttt{EventManager} et les classes pour gérer les différents types d'\texttt{event}
\item \texttt{group} : contient les classes qui implémentent les groupes des agents
